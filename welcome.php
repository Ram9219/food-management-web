...
<nav class="navbar navbar-expand-lg navbar-light">
  ...
  <div class="collapse navbar-collapse" id="navbarNav">
    <ul class="navbar-nav ml-auto">
      ...
      <!-- <li class="nav-item">
        <a class="nav-link"href="searchoption.php">SEARCH</a> -->
        <li class="nav-item dropdown active">
        <a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
          SEARCH
        </a>
        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
          <a class="dropdown-item">By Ingredients</a>
          <a class="dropdown-item" href="./searchoption.php">--->Calories</a>
            <a class="dropdown-item" href="./searcht.php">--->Prep Time</a>
          <a class="dropdown-item" href="./map.php">By Location</a>
          <a class="dropdown-item" href="./search.php">For Recipes</a>
      </li>
    <li class="nav-item">
    ...
    <li class="nav-item">
         ...
         <!-- <a class="btn btn-warning" href="reset-password.php">Reset</a>
...
<div id="headerSlider" class="carousel slide" data-ride="carousel">
  ...
  <div class="carousel-inner">
    <div class="carousel-item active">
        <img class="d-block img-fluid" src="/back3.jpg" >
      <div class="carousel-caption">
         <h5>Are You Hungry?</h5>
      </div>
    </div> 
  <div class="carousel-item">
      <img class="d-block img-fluid" src="/back2.jpg" >
    <div class="carousel-caption">
       <h5>Search Delicious Recipes</h5>
    </div>
   </div>
    <div class="carousel-item">
      <img class="d-block img-fluid" src="/back1.jpg">
    <div class="carousel-caption">
       <h5>Explore More</h5>
    </div>
    </div>
...
<!------Footer End------->
<script src="/smooth-scroll.js.js"></script>
<script>
